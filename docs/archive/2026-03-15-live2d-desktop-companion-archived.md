# Archived: Live2D Desktop Companion Implementation Plan

> Status: archived on 2026-03-16
>
> Reason:
> - this plan reflects the earlier desktop pet baseline,
> - it predates the current realtime voice conversation direction,
> - it should not be used as the active architecture target for CelCat.
>
> Replaced by:
> - `docs/plans/2026-03-16-realtime-voice-agent-architecture.md`
